# Orden de producción — Heracles

**Estado: LISTA.** Identidad cerrada, inventario cerrado, separación resuelta.

**Imagen actual:** `imagenes/heracles.jpg`, **a reemplazar.** Es de un estilo anterior: la colección quedó en cine de animación 3D el 2026-09-14, con el acabado calibrado por `imagenes/teseo.jpg` y el registro emocional por `imagenes/hermes.jpg`.
...
| Edad y contextura | Adulto joven-maduro; el cuerpo humano más macizo del roster, cuello ancho y centro de gravedad bajo. | ADN |
| Rostro y cabello | Cara cuadrada y cabello corto desordenado. | ADN |
| Cabello, color | castaño oscuro | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Cabello, textura | rizado abierto corto | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
...
Dones declarados en `personajes.json`: Fuerza sobrehumana; Resistencia infinita.

Ícono de la carta en la colección: `leon`. Dependencia del identificador en la matriz: 6 de 10.

## 3. Acción y pose

Cargando o desplazando peso en vez de posar; gesto laborioso más que guerrero perfecto.
...
- **Composición:** Masa corporal dominante, con brazos separados para que la silueta respire y la piel del león se lea sin collage de trabajos.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 6 | 10 | 8 | 6 | 7 | 7 | 8 | 4 | 8 | 4 | 6 | 10 | 3 | 4 | 1 |
...
1. **Piel del león de Nemea** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Referencias a otros trabajos sólo como elementos pequeños y subordinados. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
**Par de Espejo: Thor.** El módulo Espejo de los Mundos los muestra enfrentados en pantalla, así que las dos cartas tienen que separarse solas a simple vista. Es el par donde un parecido cuesta doble.
...
| Textura | rizado abierto corto | ondulado suave |
...
Ejes numéricos que ya los separan: rigidez de materiales 4 contra 8, masa corporal 10 contra 7, anchura de hombros 10 contra 7, edad visual 6 contra 4.
...
| Textura | rizado abierto corto | corto |
...
Ejes numéricos que ya los separan: contorno superior 7 contra 2, dinamismo de pose 8 contra 3, protagonismo de fondo 3 contra 8, rigidez de materiales 4 contra 8.
...
| Textura | rizado abierto corto | ondulado grueso |
...
Ejes numéricos que ya los separan: rigidez de materiales 4 contra 8, dependencia del identificador 6 contra 9, verticalidad 4 contra 6.
...
Criterio de la ficha: Aquiles, Héctor y Thor. Debe ganar por masa corporal, cuello ancho y gesto de esfuerzo, no por armadura o barba genéricas.
...
Avatar circular, como restricción invisible: Cara + melena del león envolviendo o rompiendo un hombro. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
...
*Hércules* (Disney, 1997) y el fisicoculturista de peplum italiano.
