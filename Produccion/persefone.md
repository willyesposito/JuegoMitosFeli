# Orden de producción — Perséfone

**Estado: LISTA.** Identidad cerrada, inventario cerrado, separación resuelta.

**Imagen actual:** `imagenes/persefone.jpg`, **a reemplazar.** Es de un estilo anterior: la colección quedó en cine de animación 3D el 2026-09-14, con el acabado calibrado por `imagenes/teseo.jpg` y el registro emocional por `imagenes/hermes.jpg`.
...
| Edad y contextura | Adulta joven; cuerpo esbelto medio. | ADN |
| Rostro y cabello | Rostro corazón/oval y cabello medio-largo de caída simple. | ADN |
| Cabello, color | rubio miel oscuro | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Cabello, textura | ondulado suave | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
...
**Dualidad primavera + reino subterráneo.**

Dones declarados en `personajes.json`: Diosa de la primavera; Reina del mundo subterráneo, las dos cosas a la vez.

Ícono de la carta en la colección: `granada`. Dependencia del identificador en la matriz: 6 de 10.

## 3. Acción y pose

Un pie en cada zona visual; pose de frontera, no trabajo agrícola ni teatralidad oscura.
...
- **Composición:** Separar claramente superficie y mundo subterráneo sin partir la cara; equilibrar una zona ligera y otra pesada.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 4 | 4 | 6 | 3 | 5 | 3 | 1 | 8 | 7 | 6 | 6 | 4 | 10 | 5 | 1 |
...
1. **Dualidad primavera + reino subterráneo** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Flor y piedra/tono oscuro; no agregar fruto específico si no está en la ficha usada. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
Protagonismo de fondo asignado: 10 de 10, o sea que el contexto es esencial para leer la carta.
...
- **Psique**: mismo rostro de ojos enormes en las imágenes anteriores.

**Contra Deméter.**

| | Perséfone | Deméter |
|---|---|---|
| Cabello | rubio miel oscuro | castaño ceniza con canas |
| Textura | ondulado suave | recogido bajo |
...
Ejes numéricos que ya los separan: edad visual 4 contra 7, contorno superior 5 contra 2, verticalidad 8 contra 5, oscuridad 6 contra 3.

**Contra Hel.**

| | Perséfone | Hel |
|---|---|---|
| Cabello | rubio miel oscuro | negro |
| Textura | ondulado suave | lacio contenido |
| Piel | clara dorada | muy pálida |
| Ojos | verde oliva | gris muy claro |
...
Ejes numéricos que ya los separan: angulosidad facial 3 contra 9, contorno superior 5 contra 1, protagonismo de fondo 10 contra 6, edad visual 4 contra 7.

**Contra Psique.**

| | Perséfone | Psique |
|---|---|---|
| Cabello | rubio miel oscuro | castaño oscuro |
| Textura | ondulado suave | ondulado marcado |
| Piel | clara dorada | oliva clara |
| Ojos | verde oliva | marrón cálido |
...
Ejes numéricos que ya los separan: oscuridad 6 contra 2, dinamismo de pose 1 contra 4, protagonismo de fondo 10 contra 7, rigidez de materiales 5 contra 2.

Criterio de la ficha: Deméter y Hel. Diferenciar por juventud, composición de frontera y mezcla controlada de dos mundos.
...
Avatar circular, como restricción invisible: Rostro + una flor + una pista pétrea u oscura opuesta. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
