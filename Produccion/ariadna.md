...
| Rostro y cabello | Rostro redondo-agudo y cabello medio recogido con movimiento. | ADN |
| Cabello, color | castaño claro | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Cabello, textura | ondulado medio | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
...
Dones declarados en `personajes.json`: El ingenio del hilo; Princesa de Creta.

Ícono de la carta en la colección: `ovillo`. Dependencia del identificador en la matriz: 9 de 10.

## 3. Acción y pose

Entrega o sigue el hilo hacia fuera del cuadro; guía desde la solución.
...
- **Composición:** Laberinto queda como patrón bajo y el hilo cruza aire limpio para ser legible.
...
1. **Ovillo/hilo** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Laberinto y corona celeste como pista secundaria. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
| Textura | ondulado medio | rizado cerrado |
...
Avatar circular, como restricción invisible: Rostro + hilo cruzando el círculo + pequeño brillo de corona. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
