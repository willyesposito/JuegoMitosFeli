...
**Imagen actual:** `imagenes/artemisa.jpg`, **a reemplazar.** Es de un estilo anterior: la colección pasó a semirrealista el 2026-09-14.
...
2. **Pistas secundarias autorizadas:** Luna y animal salvaje, sólo si no compite. ADN. Subordinadas, nunca compitiendo con el identificador.
