...
2. **Pistas secundarias autorizadas:** Sólo contexto ya existente; no agregar hoz ni objeto canónico externo si no está autorizado en el repo. ADN. Subordinadas, nunca compitiendo con el identificador.
