...
2. **Pistas secundarias autorizadas, y van en la imagen:** Sólo contexto ya existente; no agregar hoz ni objeto canónico externo si no está autorizado en el repo. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
