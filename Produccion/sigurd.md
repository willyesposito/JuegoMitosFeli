# Orden de producción — Sigurd

**Estado: LISTA.** Identidad cerrada, inventario cerrado, separación resuelta.

**Imagen actual:** `imagenes/sigurd.jpg`, **a reemplazar.** Es de un estilo anterior: la colección quedó en cine de animación 3D el 2026-09-14, con el acabado calibrado por `imagenes/teseo.jpg` y el registro emocional por `imagenes/hermes.jpg`.
...
| Edad y contextura | Adulto joven-maduro; atlético fuerte. | ADN |
| Rostro y cabello | Rostro cuadrado estrecho y cabello medio práctico. | ADN |
| Cabello, color | castaño claro | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Cabello, textura | medio práctico | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
...
**Capacidad de entender aves vinculada al desafío de Fafnir.**

Dones declarados en `personajes.json`: El gran héroe nórdico; Venció al dragón Fafnir.

Ícono de la carta en la colección: `dragon`. Dependencia del identificador en la matriz: 5 de 10.
...
Escucha a los pájaros después del desafío; no escena de combate.
...
- **Composición:** Aves cerca del rostro y Fafnir subordinado en fondo para que no absorba la lectura del personaje.
...
1. **Capacidad de entender aves vinculada al desafío de Fafnir** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Dragón Fafnir y aves. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
- **Hermes**: misma construcción facial, separados sólo por el color de pelo.

**Par de Espejo: Aquiles.** El módulo Espejo de los Mundos los muestra enfrentados en pantalla, así que las dos cartas tienen que separarse solas a simple vista. Es el par donde un parecido cuesta doble.

**Contra Aquiles.**

| | Sigurd | Aquiles |
|---|---|---|
| Cabello | castaño claro | rubio miel |
| Textura | medio práctico | ondulado suave |
...
Ejes numéricos que ya los separan: dinamismo de pose 2 contra 7, protagonismo de fondo 7 contra 4, contorno superior 4 contra 6, apertura corporal 4 contra 6.
...
Ejes numéricos que ya los separan: angulosidad facial 7 contra 4, contorno superior 4 contra 2, apertura corporal 4 contra 6, dependencia del identificador 5 contra 7.
...
| Textura | medio práctico | rizado abierto |
| Piel | clara dorada | clara dorada con pecas |
...
Ejes numéricos que ya los separan: dinamismo de pose 2 contra 10, angulosidad facial 7 contra 3, apertura corporal 4 contra 8, dependencia del identificador 5 contra 9.

Criterio de la ficha: Héctor y Aquiles. Diferenciar por interacción con aves, ausencia de pose guerrera y vocabulario nórdico.
...
Avatar circular, como restricción invisible: Rostro + un pájaro muy cerca. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
...
El Siegfried wagneriano con casco cornudo, y *Skyrim*.
