# Orden de producción — Belerofonte
...
| Familia de encuadre | figura humana con montura | ADN |
| Edad y contextura | Adulto joven; atlético ligero. | ADN |
| Rostro y cabello | Rostro largo limpio y cabello corto. | ADN |
...
Dones declarados en `personajes.json`: Domó a Pegaso con una brida de oro que le regaló Atenea.

Ícono de la carta en la colección: `brida`. Dependencia del identificador en la matriz: 10 de 10.

## 3. Acción y pose

Montado en vuelo, no vuelo corporal propio.
...
- **Composición:** Belerofonte y Pegaso deben leerse como una unidad; reservar ancho para alas sin cortar la zona segura del avatar.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 4 | 5 | 7 | 5 | 3 | 7 | 8 | 8 | 8 | 3 | 10 | 5 | 7 | 6 | 7 |
...
1. **Pegaso + brida de oro** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Vuelo y lenguaje de montura, sin sumar equipamiento no previsto. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
Avatar circular, como restricción invisible: Deben entrar rostro de Belerofonte + cabeza de Pegaso en el mismo círculo. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
