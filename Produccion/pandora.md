# Orden de producción — Pandora

**Estado: LISTA.** Identidad cerrada, inventario cerrado, separación resuelta.

**Imagen actual:** `imagenes/pandora.jpg`, **a reemplazar.** Es de un estilo anterior: la colección quedó en cine de animación 3D el 2026-09-14, con el acabado calibrado por `imagenes/teseo.jpg` y el registro emocional por `imagenes/hermes.jpg`.
...
| Rostro y cabello | Rostro redondo curioso y cabello largo recogido parcialmente. | ADN |
| Cabello, color | pelirrojo | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Cabello, textura | rizado abierto | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Piel | clara rosada con pecas | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
...
Dones declarados en `personajes.json`: Curiosidad infinita; La primera mujer, creada por los dioses con un regalo de cada uno.

Ícono de la carta en la colección: `jarra`. Dependencia del identificador en la matriz: 10 de 10.

## 3. Acción y pose

Agachada observando la jarra con curiosidad, no terror.
...
- **Composición:** Elementos que salen son abstractos y suaves; un punto de luz de esperanza debe conservarse sin saturar la zona superior.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 4 | 4 | 5 | 2 | 4 | 5 | 4 | 2 | 7 | 4 | 10 | 4 | 5 | 3 | 1 |
...
1. **Jarra** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Esperanza final como punto de luz y elementos abstractos suaves. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
| | Pandora | Psique |
|---|---|---|
| Cabello | pelirrojo | castaño oscuro |
| Textura | rizado abierto | ondulado marcado |
| Piel | clara rosada con pecas | oliva clara |
...
Ejes numéricos que ya los separan: verticalidad 2 contra 6, contorno superior 4 contra 6, densidad visual 7 contra 5, oscuridad 4 contra 2.
...
Criterio de la ficha: Psique. Diferenciar por objeto central, dirección de mirada hacia abajo y curiosidad material.
...
Avatar circular, como restricción invisible: Rostro curioso + borde de jarra + pequeño brillo. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
