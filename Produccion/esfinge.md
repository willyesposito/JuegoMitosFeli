...
| Edad y contextura | Figura híbrida adulta; cuerpo de león robusto y presencia majestuosa. | ADN |
| Rostro y cabello | Rostro de mujer según define el repo; transición limpia hacia anatomía leonina, sin rasgos monstruosos. | ADN |
...
**Anatomía híbrida + acertijo.**

Dones declarados en `personajes.json`: Guardiana de acertijos; Solo pasa quien responde bien.

Ícono de la carta en la colección: `esfinge`. Dependencia del identificador en la matriz: 1 de 10.

## 3. Acción y pose

Mira con curiosidad a quien responde; quietud de acertijo, no amenaza.
...
- **Composición:** Camino bloqueado queda visible y el cuerpo leonino debe leerse completo; aire alrededor del rostro humano.
...
1. **Anatomía híbrida + acertijo** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Camino y contexto de pregunta. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
Avatar circular, como restricción invisible: Rostro humano + una oreja/pata o parte del pecho leonino para conservar la hibridez. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
...
La Gran Esfinge de Guiza, que es egipcia y no griega.
