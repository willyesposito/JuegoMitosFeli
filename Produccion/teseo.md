...
| Edad y contextura | Adulto joven; atlético medio y ágil. | ADN |
| Rostro y cabello | Cara más redonda que Odiseo y Aquiles; cabello corto rizado o quebrado. | ADN |
| Cabello, color | castaño oscuro | sale de la imagen ya aprobada por Willy, no se toca |
| Cabello, textura | rizado cerrado | sale de la imagen ya aprobada por Willy, no se toca |
| Piel | oliva media | sale de la imagen ya aprobada por Willy, no se toca |
...
Dones declarados en `personajes.json`: Ingenio para resolver laberintos; Coraje frente a lo desconocido.

Ícono de la carta en la colección: `laberinto`. Dependencia del identificador en la matriz: 7 de 10.

## 3. Acción y pose

Una mano guía el hilo y la otra queda libre; exploración activa, no pose heroica frontal.
...
- **Composición:** Laberinto subordinado en fondo; aire en la dirección del hilo para que su curva sea legible.
...
1. **Hilo** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Laberinto; la espada nunca debe convertirse en protagonista. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
Ejes numéricos que ya los separan: masa corporal 6 contra 4, apertura corporal 6 contra 8, dinamismo de pose 6 contra 4, dependencia del identificador 7 contra 9.
...
| Textura | rizado cerrado | rizado abierto |
...
Ejes numéricos que ya los separan: dinamismo de pose 6 contra 10, masa corporal 6 contra 3, anchura de hombros 6 contra 3, protagonismo de fondo 6 contra 3.

**Atención: 9 de 15 ejes están dentro de un punto.** Son personajes genuinamente cercanos y la diferencia tiene que venir de identidad, silueta y pose, no de los números.

Criterio de la ficha: Perseo, Ariadna y Odiseo. Diferenciar por pose terrestre de exploración y uso activo del hilo, no equipamiento mágico ni rol de guía desde la solución.
...
Avatar circular, como restricción invisible: Rostro + hilo cruzando cerca del hombro + geometría de laberinto detrás. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
