...
**Imagen actual:** `imagenes/sif.jpg`, **a reemplazar.** Es de un estilo anterior: la colección quedó en cine de animación 3D el 2026-09-14, con el acabado calibrado por `imagenes/teseo.jpg` y el registro emocional por `imagenes/hermes.jpg`.
...
2. **Pistas secundarias autorizadas, y van en la imagen:** Campo de trigo. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
