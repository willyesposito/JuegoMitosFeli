...
| Rostro y cabello | Rostro oval simétrico y cabello corto ondulado muy cuidado. | ADN |
...
Dones declarados en `personajes.json`: Belleza extraordinaria; Su historia le dio nombre a una flor.

Ícono de la carta en la colección: `flor_narciso`. Dependencia del identificador en la matriz: 7 de 10.

## 3. Acción y pose

Agachado mirando el reflejo.
...
- **Composición:** Composición vertical duplicada por el agua; reservar superficie limpia para que el reflejo sea legible.
...
1. **Reflejo en agua** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Flor de narciso. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
| Textura | ondulado suave | corto en capas |
| Piel | clara dorada | oliva media |
| Ojos | verde oliva | gris |

Silueta de Eco, para no repetirla: cuerpo parcialmente oculto por roca/vegetación + ondas de sonido rompiendo el contorno hacia dos lados.

Pose de Eco, para no repetirla: mano cerca de la boca sin gesto exagerado; cuerpo quieto.
...
Avatar circular, como restricción invisible: Rostro + borde del reflejo o flor. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
