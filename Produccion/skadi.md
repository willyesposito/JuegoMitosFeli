...
| Edad y contextura | Adulta madura; atlética alta y de mayor masa que Artemisa. | ADN |
| Rostro y cabello | Rostro angular; cabello trenzado y muy contenido. | ADN |
| Cabello, color | castaño muy oscuro | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Cabello, textura | trenzado contenido | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Piel | clara pálida | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Ojos | gris hielo | decisión de diseño visual, sin atestación localizada; revisable por la investigación |

## 2. Detalle reconocible

**Esquí y nieve.**

Dones declarados en `personajes.json`: Giganta de las montañas; Esquiadora y cazadora en la nieve.

Ícono de la carta en la colección: `esquis`. Dependencia del identificador en la matriz: 8 de 10.

## 3. Acción y pose

Como frenando sobre nieve; arco en reposo.
...
- **Composición:** Gran espacio negativo de montaña, con diagonales largas que no choquen con el borde 3:4.
...
1. **Esquí y nieve** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Arco de caza, montaña y ropa de invierno. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
| Textura | trenzado contenido | crespo recogido alto |
| Piel | clara pálida | castaña media |
| Ojos | gris hielo | marrón muy oscuro |
...
Avatar circular, como restricción invisible: Rostro + borde de capucha/trenza + nieve; puede entrar un extremo del arco. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
