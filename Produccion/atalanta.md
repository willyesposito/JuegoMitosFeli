...
| Rostro y cabello | Rostro cuadrado suave; cabello corto-medio recogido alto. | ADN |
| Cabello, color | negro | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Cabello, textura | crespo recogido alto | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
...
**Velocidad/caza + manzanas de oro de la carrera.**

Dones declarados en `personajes.json`: La corredora más veloz de Grecia; Cazadora experta.

Ícono de la carta en la colección: `manzana`. Dependencia del identificador en la matriz: 8 de 10.

## 3. Acción y pose

Cuerpo inclinado en carrera física; arco bajo, no en uso.
...
- **Composición:** Composición baja/horizontal dentro del 3:4; tres manzanas pueden formar trayectoria sin dominar.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 4 | 4 | 6 | 4 | 2 | 8 | 10 | 4 | 7 | 3 | 8 | 4 | 4 | 6 | 1 |
...
1. **Velocidad/caza + manzanas de oro de la carrera** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Arco y hasta tres manzanas en trayectoria. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
| Textura | crespo recogido alto | lacio recogido alto |
...
Ejes numéricos que ya los separan: dinamismo de pose 10 contra 3, apertura corporal 8 contra 4, verticalidad 4 contra 6, densidad visual 7 contra 5.
...
| Textura | crespo recogido alto | rizado abierto |
| Piel | castaña media | clara dorada con pecas |
| Ojos | marrón muy oscuro | verde oliva |
...
Avatar circular, como restricción invisible: Rostro en movimiento + una manzana dorada o borde de arco. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
