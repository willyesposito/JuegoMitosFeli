# Orden de producción — Rómulo y Remo

**Estado: LISTA.** Identidad cerrada, inventario cerrado, separación resuelta.

**Imagen actual:** `imagenes/romulo_remo.jpg`, **a reemplazar.** Es de un estilo anterior: la colección quedó en cine de animación 3D el 2026-09-14, con el acabado calibrado por `imagenes/teseo.jpg` y el registro emocional por `imagenes/hermes.jpg`.
...
| Edad y contextura | Gemelos adultos jóvenes con similitud familiar real pero no clones; contexturas deliberadamente distintas. | ADN |
| Rostro y cabello | Rostros con parentesco visible pero diferencias de ancho, gesto y orientación; cabello emparentado sin duplicación exacta. | ADN |
...
**Dupla de gemelos + loba.**

Dones declarados en `personajes.json`: Criados por una loba que los protegió de niños; Fundadores de la ciudad de Roma.

Ícono de la carta en la colección: `loba_capitolina`. Dependencia del identificador en la matriz: 9 de 10.

## 3. Acción y pose

Uno señala el terreno y el otro observa la colina; ambos coprotagonistas.
...
- **Composición:** Triángulo visual con loba baja y colina/surco subordinado; espacio suficiente entre cabezas para que el avatar no las fusione.
- **Densidad visual:** alta (matriz: 9 de 10).

- **Cuerpo, y esto manda sobre cualquier intuición:** joven, de contextura media, atlética sin volumen, hombros de ancho medio, de escala algo mayor que humana.
...
1. **Dupla de gemelos + loba** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Colina y elemento de fundación de Roma ya definido. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
**Contra Cástor y Pólux.**

Silueta de Cástor y Pólux, para no repetirla: dos cuerpos paralelos con inclinaciones opuestas + dos estrellas altas separadas.

Pose de Cástor y Pólux, para no repetirla: ambos de pie, hombros tocándose o conectados por gesto; nunca espejo exacto.

Ejes numéricos que ya los separan: dinamismo de pose 5 contra 2, dependencia del identificador 9 contra 6, protagonismo de fondo 9 contra 6, apertura corporal 8 contra 6.
...
Criterio de la ficha: Cástor y Pólux. Diferenciar por loba, asimetría de roles y eje terrestre/fundacional en vez de lectura celeste.
...
Avatar circular, como restricción invisible: Deben entrar ambos rostros + orejas/cabeza de la loba o una pista inequívoca; nunca recortar a un solo hermano. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
...
La Loba Capitolina. La escultura los muestra bebés y es lo que produjo la imagen anterior, que contradice la ficha: la ficha pide gemelos adultos jóvenes fundando la ciudad.
