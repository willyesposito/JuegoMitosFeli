# Orden de producción — Psique

**Estado: LISTA.** Identidad cerrada, inventario cerrado, separación resuelta.

**Imagen actual:** `imagenes/psique.jpg`, **a reemplazar.** Es de un estilo anterior: la colección quedó en cine de animación 3D el 2026-09-14, con el acabado calibrado por `imagenes/teseo.jpg` y el registro emocional por `imagenes/hermes.jpg`.
...
| Rostro y cabello | Rostro corazón y cabello medio-largo suave. | ADN |
...
**Mariposa como representación visual del “alma” según el icono del proyecto.**

Dones declarados en `personajes.json`: Curiosidad y determinación; Su nombre significa «alma» en griego.

Ícono de la carta en la colección: `mariposa_alma`. Dependencia del identificador en la matriz: 8 de 10.

## 3. Acción y pose

Avanza entre pruebas con cautela y perseverancia.
...
- **Composición:** Dejar aire en la dirección de avance; pruebas se sugieren de forma abstracta y no saturan el fondo.
...
1. **Mariposa como representación visual del “alma” según el icono del proyecto** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Vínculo con Eros y pruebas como contexto abstracto. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
- **Perséfone**: mismo rostro de ojos enormes en las imágenes anteriores.
...
| Textura | ondulado marcado | ondulado amplio |
...
Ejes numéricos que ya los separan: contorno superior 6 contra 9, apertura corporal 5 contra 7, dinamismo de pose 4 contra 2, dependencia del identificador 8 contra 6.
...
Ejes numéricos que ya los separan: protagonismo de fondo 7 contra 2, contorno superior 6 contra 4, apertura corporal 5 contra 7, dinamismo de pose 4 contra 6.
...
| | Psique | Perséfone |
|---|---|---|
| Cabello | castaño oscuro | rubio miel oscuro |
...
Ejes numéricos que ya los separan: oscuridad 2 contra 6, dinamismo de pose 4 contra 1, protagonismo de fondo 7 contra 10, rigidez de materiales 2 contra 5.

Criterio de la ficha: Eros y Afrodita. Diferenciar por ausencia de arco, energía perseverante y estética propia que no copie a Afrodita.
...
Avatar circular, como restricción invisible: Rostro + mariposa clara. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
