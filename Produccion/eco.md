...
| Edad y contextura | Adulta joven; pequeña y ligera. | ADN |
| Rostro y cabello | Rostro redondo expresivo; cabello corto-medio en capas suaves. | ADN |
| Cabello, color | castaño medio | ya declarado en el ADN, precisado sin contradecirlo |
| Cabello, textura | corto en capas | ya declarado en el ADN, precisado sin contradecirlo |
...
**Repetición de voz/eco.**

Dones declarados en `personajes.json`: Voz que se multiplica sin fin; Compañera fiel de los bosques.

Ícono de la carta en la colección: `ondas_sonido`. Dependencia del identificador en la matriz: 6 de 10.

## 3. Acción y pose

Mano cerca de la boca sin gesto exagerado; cuerpo quieto.
...
- **Composición:** Reservar aire para dos o tres ondas concéntricas claras y mantener roca/vegetación subordinadas.
- **Densidad visual:** baja (matriz: 4 de 10).
...
1. **Repetición de voz/eco** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Montaña/valle y ondas de sonido. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
| | Eco | Narciso |
|---|---|---|
| Cabello | castaño medio | castaño oscuro |
| Textura | corto en capas | ondulado suave |
...
| | Eco | Hermes |
|---|---|---|
| Cabello | castaño medio | cobrizo |
| Textura | corto en capas | rizado abierto |
...
Ejes numéricos que ya los separan: dinamismo de pose 2 contra 10, protagonismo de fondo 9 contra 3, apertura corporal 4 contra 8, dependencia del identificador 6 contra 9.
...
| Textura | corto en capas | largo recogido parcialmente |
...
Avatar circular, como restricción invisible: Rostro + dos o tres ondas concéntricas claras. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
