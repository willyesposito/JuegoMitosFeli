# Orden de producción — Iris

**Estado: LISTA.** Identidad cerrada, inventario cerrado, separación resuelta.

**Imagen actual:** `imagenes/iris.jpg`, **a reemplazar.** Es de un estilo anterior: la colección quedó en cine de animación 3D el 2026-09-14, con el acabado calibrado por `imagenes/teseo.jpg` y el registro emocional por `imagenes/hermes.jpg`.
...
| Edad y contextura | Adulta joven; ligera. | ADN |
| Rostro y cabello | Rostro oval alegre; cabello largo recogido parcialmente para sugerir movimiento. | ADN |
| Cabello, color | castaño claro | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Cabello, textura | largo recogido parcialmente | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
...
**Arcoíris como camino.**

Dones declarados en `personajes.json`: Mensajera de los dioses que viaja por el arcoíris.

Ícono de la carta en la colección: `iris`. Dependencia del identificador en la matriz: 10 de 10.

## 3. Acción y pose

Movimiento de mensajera aérea; no carrera terrestre.
...
- **Composición:** Arcoíris funciona como camino y curva compositiva, con aire delante de la trayectoria y sin encerrar la figura.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 4 | 3 | 6 | 2 | 7 | 9 | 9 | 8 | 7 | 1 | 10 | 3 | 4 | 2 | 1 |
...
1. **Arcoíris como camino** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Telas/velo de movimiento y transición cielo-tierra. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
- **Heimdall**: el arcoíris dominaba las dos imágenes por igual.

**Contra Heimdall.**

| | Iris | Heimdall |
|---|---|---|
| Cabello | castaño claro | rubio ceniza |
| Textura | largo recogido parcialmente | recogido atrás |
...
Ejes numéricos que ya los separan: dinamismo de pose 9 contra 1, rigidez de materiales 2 contra 9, apertura corporal 9 contra 3, angulosidad facial 2 contra 7.
...
| Textura | largo recogido parcialmente | rizado abierto |
...
Ejes numéricos que ya los separan: contorno superior 7 contra 4, verticalidad 8 contra 5, densidad visual 7 contra 5, rigidez de materiales 2 contra 4.
...
Criterio de la ficha: Hermes y Heimdall. Diferenciar por composición aérea, movimiento continuo y ausencia de cuerno o carrera terrestre.
...
Avatar circular, como restricción invisible: Rostro + banda de arcoíris claramente visible. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
