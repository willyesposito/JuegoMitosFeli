# Orden de producción — Perseo

**Estado: LISTA.** Identidad cerrada, inventario cerrado, separación resuelta.

**Imagen actual:** `imagenes/perseo.jpg`, **a reemplazar.** Es de un estilo anterior: la colección quedó en cine de animación 3D el 2026-09-14, con el acabado calibrado por `imagenes/teseo.jpg` y el registro emocional por `imagenes/hermes.jpg`.
...
| Edad y contextura | Adulto joven; cuerpo ágil y ligero. | ADN |
| Rostro y cabello | Rostro oval corto y cabello rizado compacto. | ADN |
| Cabello, color | negro | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Cabello, textura | ondulado marcado | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Piel | canela | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Ojos | negro | decisión de diseño visual, sin atestación localizada; revisable por la investigación |

## 2. Detalle reconocible

**Escudo espejo + sandalias voladoras como sistema conjunto.**

Dones declarados en `personajes.json`: Sandalias voladoras; Escudo espejo; Casco de invisibilidad.

Ícono de la carta en la colección: `escudo`. Dependencia del identificador en la matriz: 9 de 10.

## 3. Acción y pose

Mira el reflejo del escudo en vez de dirigir la mirada al peligro; sensación de vuelo propio.
...
- **Composición:** Escudo desplazado para leer su superficie y aire en la dirección ascendente; las sandalias deben entrar completas en la imagen maestra.
- **Densidad visual:** alta (matriz: 8 de 10).

- **Cuerpo, y esto manda sobre cualquier intuición:** joven, de contextura media, atlética sin volumen, hombros de ancho medio, de escala humana.
...
1. **Escudo espejo + sandalias voladoras como sistema conjunto** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Casco de invisibilidad. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
- **Teseo**: misma cara y mismo pelo en las imágenes anteriores.
...
Ejes numéricos que ya los separan: rareza anatómica 1 contra 7, protagonismo de fondo 4 contra 7.
...
Ejes numéricos que ya los separan: verticalidad 8 contra 4, densidad visual 8 contra 5, dinamismo de pose 8 contra 6, dependencia del identificador 9 contra 7.
...
| | Perseo | Hermes |
|---|---|---|
| Cabello | negro | cobrizo |
| Textura | ondulado marcado | rizado abierto |
| Piel | canela | clara dorada con pecas |
| Ojos | negro | verde oliva |
...
Ejes numéricos que ya los separan: verticalidad 8 contra 5, densidad visual 8 contra 5, masa corporal 5 contra 3, dinamismo de pose 8 contra 10.

**Atención: 9 de 15 ejes están dentro de un punto.** Son personajes genuinamente cercanos y la diferencia tiene que venir de identidad, silueta y pose, no de los números.

Criterio de la ficha: Belerofonte y Teseo. Diferenciar por vuelo propio, geometría circular del escudo y equipamiento mágico.
...
Avatar circular, como restricción invisible: Rostro reflejado parcialmente en el borde del escudo o rostro + brillo inequívoco del escudo. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
...
*Furia de titanes* (2010): armadura de cuero y espada brillante.
