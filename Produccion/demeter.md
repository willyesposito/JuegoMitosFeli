# Orden de producción — Deméter

**Estado: LISTA.** Identidad cerrada, inventario cerrado, separación resuelta.

**Imagen actual:** `imagenes/demeter.jpg`, **a reemplazar.** Es de un estilo anterior: la colección quedó en cine de animación 3D el 2026-09-14, con el acabado calibrado por `imagenes/teseo.jpg` y el registro emocional por `imagenes/hermes.jpg`.
...
| Edad y contextura | Adulta madura; cuerpo fuerte de trabajo sin musculatura heroica. | ADN |
| Rostro y cabello | Rostro ancho suave; cabello recogido bajo. | ADN |
| Cabello, color | castaño ceniza con canas | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Cabello, textura | recogido bajo | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Piel | dorada media | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Ojos | avellana | decisión de diseño visual, sin atestación localizada; revisable por la investigación |

## 2. Detalle reconocible

**Cosechas y crecimiento.**

Dones declarados en `personajes.json`: Diosa de las cosechas; Hace crecer todo lo que se planta.

Ícono de la carta en la colección: `espigas`. Dependencia del identificador en la matriz: 6 de 10.

## 3. Acción y pose

Manos activas trabajando con plantas o semillas.
...
- **Composición:** Crecimiento controlado alrededor de la figura, con una masa vegetal lateral y espacio limpio en el lado opuesto.
...
1. **Cosechas y crecimiento** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Cambio estacional como pista ambiental. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
- **Sif**: la imagen anterior de Sif ejecutaba la acción de Deméter.

**Par de Espejo: Sif.** El módulo Espejo de los Mundos los muestra enfrentados en pantalla, así que las dos cartas tienen que separarse solas a simple vista. Es el par donde un parecido cuesta doble.

**Contra Perséfone.**

| | Deméter | Perséfone |
|---|---|---|
| Cabello | castaño ceniza con canas | rubio miel oscuro |
| Textura | recogido bajo | ondulado suave |
| Piel | dorada media | clara dorada |
| Ojos | avellana | verde oliva |

Silueta de Perséfone, para no repetirla: mitad superior ligera con flores/vegetación + parte baja más pesada por telas oscuras; dualidad vertical sin rostro partido.
...
Ejes numéricos que ya los separan: edad visual 7 contra 4, contorno superior 2 contra 5, verticalidad 5 contra 8, oscuridad 3 contra 6.

**Contra Dafne.**

| | Deméter | Dafne |
|---|---|---|
| Cabello | castaño ceniza con canas | castaño claro |
| Textura | recogido bajo | largo mezclándose con hojas |
| Piel | dorada media | clara dorada |
| Ojos | avellana | verde oliva |
...
Ejes numéricos que ya los separan: contorno superior 2 contra 9, rareza anatómica 1 contra 7, verticalidad 5 contra 9, dependencia del identificador 6 contra 2.

**Contra Sif.**

| | Deméter | Sif |
|---|---|---|
| Cabello | castaño ceniza con canas | oro verdadero |
| Textura | recogido bajo | extremadamente largo y pesado |
| Piel | dorada media | clara dorada |
| Ojos | avellana | ámbar |
...
Ejes numéricos que ya los separan: contorno superior 2 contra 10, dependencia del identificador 6 contra 10, protagonismo de fondo 7 contra 4, edad visual 7 contra 5.
...
Criterio de la ficha: Perséfone y Dafne. Diferenciar por mayor edad, peso corporal y vínculo de trabajo con la tierra, no transformación ni composición de frontera.
...
Avatar circular, como restricción invisible: Rostro + espigas cruzando un hombro. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
