# Orden de producción — Atlas

**Estado: LISTA.** Identidad cerrada, inventario cerrado, separación resuelta.

**Imagen actual:** `imagenes/atlas.jpg`, **a reemplazar.** Es de un estilo anterior: la colección quedó en cine de animación 3D el 2026-09-14, con el acabado calibrado por `imagenes/teseo.jpg` y el registro emocional por `imagenes/hermes.jpg`.
...
| Familia de encuadre | escala grande | ADN |
| Edad y contextura | Titán enorme; torso y brazos masivos, cabeza relativamente pequeña. | ADN |
| Rostro y cabello | Rostro ancho, fatigado pero digno; cabello subordinado a la lectura de esfuerzo y escala. | ADN |
| Cabello, color | castaño grisáceo | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
| Cabello, textura | subordinado a la escala | decisión de diseño visual, sin atestación localizada; revisable por la investigación |
...
**Bóveda celeste cargada físicamente.**

Dones declarados en `personajes.json`: Fuerza titánica; Sostiene el cielo entero.

Ícono de la carta en la colección: `atlas`. Dependencia del identificador en la matriz: 10 de 10.

## 3. Acción y pose

Piernas muy separadas y brazos sosteniendo físicamente la bóveda.
...
- **Composición:** Paisaje pequeño refuerza escala; la curva celeste debe quedar separada del cráneo para conservar la firma en negro puro.
- **Densidad visual:** alta (matriz: 9 de 10).

- **Cuerpo, y esto manda sobre cualquier intuición:** entrado en años, de masa enorme, muy por encima de lo humano, hombros muy anchos, que dominan la silueta, de escala claramente sobrehumana.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 8 | 10 | 10 | 7 | 4 | 3 | 5 | 9 | 9 | 7 | 10 | 10 | 8 | 5 | 3 |
...
1. **Bóveda celeste cargada físicamente** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Paisaje o referencia de escala pequeña. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
| | Atlas | Cronos |
|---|---|---|
| Cabello | castaño grisáceo | gris oscuro |
| Textura | subordinado a la escala | amplio |
| Piel | canela | oliva clara |
| Ojos | ámbar | negro |

Silueta de Cronos, para no repetirla: gran masa de hombros + manto antiguo cayendo en bloque + cabeza relativamente pequeña para enfatizar escala.

Pose de Cronos, para no repetirla: cuerpo quieto, autoridad cerrada; el entorno sugiere conflicto generacional sin teatralizarlo.

Ejes numéricos que ya los separan: dependencia del identificador 10 contra 3, dinamismo de pose 5 contra 1, contorno superior 4 contra 7, protagonismo de fondo 8 contra 5.
...
Criterio de la ficha: Cronos. Diferenciar por acción de carga inequívoca y silueta arqueada, no autoridad inmóvil.
...
Avatar circular, como restricción invisible: Rostro + manos/brazos + arco celeste dentro del círculo. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
