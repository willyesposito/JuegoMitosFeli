...
| Rostro y cabello | Rostro alargado, ojos grandes atentos y cabello oscuro largo de poco volumen. | ADN |
| Cabello, color | negro | ya declarado en el ADN, precisado sin contradecirlo |
| Cabello, textura | lacio largo de poco volumen | ya declarado en el ADN, precisado sin contradecirlo |
...
**Gesto de advertencia + contexto troyano.**

Dones declarados en `personajes.json`: Don de la profecía; Ve el futuro con total claridad.

Ícono de la carta en la colección: `vision`. Dependencia del identificador en la matriz: 3 de 10.

## 3. Acción y pose

Advertencia activa mediante mirada y manos; ninguna magia lanzada.
...
- **Composición:** Reservar espacio en la dirección señalada para que la advertencia tenga destino visual; Troya queda como contexto.
...
1. **Gesto de advertencia + contexto troyano** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Muralla o arquitectura de Troya; no herramientas proféticas inventadas. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
| Textura | lacio largo de poco volumen | ondas pesadas |
...
| Textura | lacio largo de poco volumen | grueso recogido práctico |
| Piel | oliva media ⚠ igual | oliva media |
| Ojos | marrón muy oscuro | negro |
...
Ejes numéricos que ya los separan: apertura corporal 8 contra 3, contorno superior 6 contra 3, verticalidad 6 contra 3, densidad visual 5 contra 7.
...
Avatar circular, como restricción invisible: Rostro intenso + mano abierta o silueta de muralla. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
