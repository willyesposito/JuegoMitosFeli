...
| Edad y contextura | Perro adulto enorme, robusto y de patas pesadas. | ADN |
| Rostro y cabello | No aplica rostro humano; tres cabezas caninas con expresiones distintas pero compatibles, pelaje robusto y sin rasgos terroríficos. | ADN |
...
Dones declarados en `personajes.json`: Perro guardián de tres cabezas; Nadie pasa sin permiso.

Ícono de la carta en la colección: `cerbero`. Dependencia del identificador en la matriz: 1 de 10.

## 3. Acción y pose

Sentado o quieto ante una entrada.
...
- **Composición:** Escalonar las tres cabezas para evitar solapamiento; entrada subordinada y aire suficiente entre perfiles.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 6 | 10 | 7 | 5 | 7 | 4 | 1 | 5 | 9 | 7 | 1 | 10 | 6 | 2 | 10 |
...
1. **Tres cabezas** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Función de guardián y entrada al inframundo como contexto. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
Ejes numéricos que ya los separan: angulosidad facial 5 contra 8, rareza anatómica 10 contra 8.
...
Criterio de la ficha: Fenrir. Diferenciar por multiplicidad, postura quieta y cuerpo más ancho.
...
Avatar circular, como restricción invisible: Deben entrar las tres cabezas; si una queda afuera, el avatar falla. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
