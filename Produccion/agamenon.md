# Orden de producción — Agamenón

**Estado: LISTA.** Identidad cerrada, inventario cerrado, separación resuelta.

**Imagen actual:** `imagenes/agamenon.jpg`, **a reemplazar.** Es de un estilo anterior: la colección quedó en cine de animación 3D el 2026-09-14, con el acabado calibrado por `imagenes/teseo.jpg` y el registro emocional por `imagenes/hermes.jpg`.
...
| Edad y contextura | Adulto maduro; robusto. | ADN |
| Rostro y cabello | Rostro rectangular ancho, barba corta muy cuidada y cabello corto rubio. | ADN |
| Cabello, color | rubio | atestación citada en la ficha del ADN |
| Cabello, textura | corto | atestación citada en la ficha del ADN |
| Piel | oliva clara | atestación citada en la ficha del ADN |
| Ojos | avellana | atestación citada en la ficha del ADN |

## 2. Detalle reconocible

**Cetro y gran flota como sistema de mando.**

Dones declarados en `personajes.json`: Rey de Micenas; Líder de todos los reyes griegos en la guerra de Troya.

Ícono de la carta en la colección: `cetro`. Dependencia del identificador en la matriz: 8 de 10.

## 3. Acción y pose

Cetro bajo y mano extendida hacia una flota; liderazgo antes que combate.
...
- **Composición:** Flota en segundo plano y aire hacia la mano que dirige; evitar que el cetro quede al pecho como plantilla.
...
1. **Cetro y gran flota como sistema de mando** — identificador principal. ADN.
2. **Pistas secundarias autorizadas, y van en la imagen:** Contexto de flota y capa de comandante sobre quitón corto y coraza con lambrequines. ADN. Subordinadas al identificador, nunca compitiendo con él, pero presentes.
...
Ejes numéricos que ya los separan: angulosidad facial 8 contra 4, contorno superior 2 contra 5, rigidez de materiales 8 contra 5, edad visual 7 contra 5.

**Contra Zeus.**

| | Agamenón | Zeus |
|---|---|---|
| Cabello | rubio | blanco |
| Textura | corto | ondulado abundante |
...
Ejes numéricos que ya los separan: protagonismo de fondo 8 contra 4, contorno superior 2 contra 5, apertura corporal 7 contra 9, dinamismo de pose 3 contra 5.
...
Criterio de la ficha: Jasón y Zeus. Diferenciar por rigidez regia, masa corporal y ausencia de magia.
...
Avatar circular, como restricción invisible: Rostro + cabeza del cetro. No se dibuja ningún círculo, medallón, marco, inset ni retrato secundario.
